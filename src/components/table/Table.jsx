...
const List = () => {
  ...
  const getOrders = () => {
    // const res = await axios.get('https://shipshop-api.herokuapp.com/orders?new=true',CONFIG());
    // const data = res.data.data;
    // console.log("new orders:", data);
    // setOrders(data);

    const res = axios.get('https://shipshop-api.herokuapp.com/orders?new=true', CONFIG()).then(
